...
const Login = (props) => {
			...
			axios
				...
				.catch((err) => {
					setPopup({
						open: true,
						severity: "error",
						message: "Signup Failed,Please fill all the fields",
					});
	...
	const handleLoginRecruiter = () => {
		if (signupDetails.companyName === "" || signupDetails.companyName == null) {
			setPopup({
				open: true,
				severity: "error",
			...
			return;
		} else if (signupDetails.bio === "" || signupDetails.bio == null) {
			setPopup({
				open: true,
				severity: "error",
	...
	return loggedin ? (
		...
		<>
			<Grid style={{ marginBottom: "30px" }} xs={12}></Grid>
